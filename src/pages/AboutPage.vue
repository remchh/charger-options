<template>
  <q-page class="flex column flex-center q-pa-md">
    <div>
      <h3 class="text-weight-bold">About us</h3>
    </div>
    <div style="max-width: 950px" class="text-body1">
      ...
      <p>
      Our team of experts 👩‍💻👨‍💻 has carefully curated a list of the top chargers available, based on a variety of factors, including price, reliability, and customer reviews. We've also included detailed specifications for each charger, so you can be sure you're making an informed decision.
      </p>
      If you have any questions or feedback, we'd love to hear from you. Please feel free to contact us anytime, and we'll get back to you as soon as possible.
      <p>
      Thank you for choosing our web app for all your smartphone charging needs.😁
      </p>
    </div>
  </q-page>
</template>
